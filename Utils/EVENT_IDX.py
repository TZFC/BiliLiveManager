...
event_types = {
    ...
    'BENEFIT_CARD_CLEAN', 'SHOPPING_BUBBLES_STYLE', 'SHOPPING_EXPLAIN_CARD', 'SELECTED_GOODS_INFO', 'CHANGE_ROOM_INFO',
    'CUT_OFF', 'ROOM_LOCK', 'GUARD_BENEFIT_RECEIVE', 'LITTLE_TIPS', 'COLLECTION_PRAISE_STATUS',
